...
export class Profile extends Component {
    render() {
        return ( 
           ...
           <div className = "border-bottom text-center pb-4" ></div>
           <img src = {
                require("../../assets/images/faces/face12.jpg")
            }
            alt = "profile"
          ...
          <label className = "badge badge-outline-light mr-1" > Graphic Design </label>
           ...
           < span className = "float-right text-muted" >
            ...
            <  div className = "text-center mt-4 mt-md-0" ></div>
           ...
           < li className = "nav-item" >
            ...
            <img src = {
                require("../../assets/images/faces/face13.jpg")
            }
            alt = "profile"
            ...
            Mason Beck <small className = "ml-4 text-muted" > < i className = "mdi mdi-clock mr-1" > </i>10 hours
            </small >
            </h6> 
            <p>
            ...
            <div className = "d-flex align-items-start profile-feed-item" >
            <img src = {
                require("../../assets/images/faces/face16.jpg")
            }
            alt = "profile"
            className = "img-sm rounded-circle" / >
            <div className = "pl-4" >
           ...
           <div className = "d-flex align-items-start profile-feed-item" >
            <img src = {
                require("../../assets/images/faces/face19.jpg")
            }
            alt = "profile"
            className = "img-sm rounded-circle" / >
            <div className = "pl-4" >
            ...
            for the magical combination that would put my website into the top search engine rankings </p> 
            <img src = {
            ...
            <p className = "small text-muted mt-2 mb-0" >
            <span >
            <i className = "mdi mdi-star mr-1" > </i>4 </span> 
            <span className = "ml-2" >
            <i className = "mdi mdi-comment mr-1" > </i>11 
            </span> 
            <span className = "ml-2" >
