                  ...
                  <div className="col-lg-8">
                    <div className="mt-4 py-2 right">
                      <ul className="nav profile-navbar">
                        ...
                        <li className="nav-item">
                          <a
                            className="nav-link d-flex align-items-center active settings"
                            href="!#"
                            onClick={(event) => event.preventDefault()}
                          >
                            Settings
                      ...
                      <div className="d-flex align-items-start profile-feed-item">
                        <div className="about_text">
                          <p>
                            ...
                            for a living and love what I do as every day there
                            is something new and exciting to learn.
                          </p>

                          <p>
                            In my spare time, the web development community is a
                            big part of my life. Whether teaching code to kids
                            at a local school, managing online programming
                            groups and blogs or attending a conference, I find
                          ...
                          <p>
                            ...
                            class degree with honours. While I was at university
                            I worked part time for a web design agency called
                            Surrect Media that helped me to further hone in my
                            skills as a developer. When not at work I'm usually
                            working on a new project from home which could be
                            anything to updating one of my sites to creating a
                            new CRM application. Since leaving university I've
                            been lucky enough to work for The One Point.
                          </p>
                          <p>
