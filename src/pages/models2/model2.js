                ...
                <Modal isOpen={showmodal} >
                    ...
                    <ModalBody>
                        <Form onSubmit={this.displayModalList}>
                            <FormGroup>
                                <Label> Id</Label>
                                <Input placeholder='Id' name='productId' value={this.state.productId} onChange={this.handleProductInputs} />
                            </FormGroup>
                            <FormGroup>
                                <Label>Title</Label>
                                <Input placeholder='Title' value={this.state.productName} name='productName' onChange={this.handleProductInputs} />
                            </FormGroup>
                            <FormGroup>
                                <Label>Status</Label>
